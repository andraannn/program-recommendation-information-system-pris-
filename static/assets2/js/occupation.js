$(function() {
    window.availableOccupations = [
        ...
        "Assistant culture center worker",
        "Assistant Executive Director",
        "Assistant land registration examiner",
        "Assistant psychiatric social worker",
        ...
        "Attendant, Sauna Bath/Body massage/Foot s",
        "Attorney",
        "Auctioneer",
        ...
        "Bartender helper",
        "Basketry weaver",
        "Batch still operator, chemical processes, except petr",
        "Beam warper",
        "Beater operator",
        "Beautician",
        ...
        "Blower, glass",
        "Blower, glass, scientific",
        "Board Directors and Members, organization/e",
        ...
        "Cast stone maker",
        "Caster, hand, pottery and porcelain",
        "Casting finisher",
        "Cataloguer",
        "Catcher, fish, for aquarium",
        "Catechist",
        "Cattle herder",
        "CCTV operator",
        ...
        "Chemical mixing machinery operator",
        ...
        "Crusher operator",
        "Crushing machinery operator",
        "Crystallizer operator, sugar refining",
        "Cultivator, bangus farm",
        "Cultivator, fish farm",
        "Cultivator, mussel farm",
        "Cultivator, oyster farm",
        "Cultivator, prawn farm",
        "Cultivator, seaweed",
        "Cultivator, tilapia farm",
        "Cultural dancer",
        "Cupola furnaceman",
        ...
        "Cutter, hand, stone letter",
        "Cutter, leather",
        "Cutter, mosaic",
        "Cutter, silk-screen stencil",
        "Cutter, stone",
        "Cutter, textile",
        ...
        "Derrickman, gas well",
        "Derrickman, oil well",
        "Designer, industrial and commercial products",
        ...
        "Dredgeman",
        "Dressmaker",
        "Drier operator, chemical and related processe",
        ...
        "Engineer, computer",
        "Engineer, electrical",
        "Engineer, electromechanical equipment",
        "Engineer, electronics",
        "Engineer, geodetic",
        "Engineer, heating, ventilation and refrigeration",
        ...
        "Executive Vice-Pres., organization/enterprise",
        "Expeller, oil",
        "Experienced worker seeking reemployment",
        "Extractor operator",
        ...
        "Farmer, quail",
        "Farmer, ramie",
        "Farmer, root and tuber crop",
        "Farmer, root and tuberous vegetable",
        "Farmer, rubber tree",
        "Farmer, salago",
        "Farmer, sisal",
        "Farmer, soy bean",
        "Farmer, spices and condiments",
        "Farmer, sweet potato",
        "Farmer, tea",
        "Farmer, tobacco",
        "Farmer, tomato",
        ...
        "Farmer, turtle",
        "Farmer, vineyard",
        "Farmer, white potato (Irish potato)",
        "Farmer,beans and peas, except soybean",
        "Farmer,ube",
        "Farmhand",
        "Farming adviser",
        "Fashion designer",
        ...
        "Filater press operator, chemical and related material",
        "Film custodian",
        "Film editor",
        "Film preview assistant",
        "Final audit process engineer",
        "Finance associate professional, n.e.c.",
        ...
        "Fishermen, coastal waters",
        "Fishermen, deep-sea",
        "Fishermen, inland waters",
        "Fishery caretaker",
        "Fishery enforcer",
        "Fishery enumerator",
        "Fishery helper",
        ...
        "Groundskeeper",
        "Groundsman",
        "Grower, insecticidal plant",
        "Grower, medicinal plant",
        "Grower, nursery",
        "Grower, orchid plant",
        "Grower, ornamental plant",
        "Grower, perfumery plant",
        "Grower, rose",
        "Grower, seaweed",
        "Grower, shellfish",
        "Guard patrol",
        ...
        "Inspector, mechanical products",
        "Inspector, postal",
        "Inspector, quality",
        "Inspector, safety",
        "Inspector, sales",
        "Inspector, transport service, railway",
        "Inspector, vehicles/pollution",
        "Inspector, zoning",
        "Installer, airconditioning plant",
        "Installer, central office equipment",
        "Installer, radio equipment",
        "Installer, refrigeration plant",
        "Installer, telecommunication equipment",
        "Installer, telegraph",
        "Installer, telephone",
        ...
        "Insulator, air-conditioning equipment",
        "Insulator, boiler",
        "Insulator, building, general",
        "Insulator, building, machine",
        "Insulator, pipe",
        ...
        "Jig maker",
        "Jig tender",
        "Jiggerman, pottery and porcelain",
        ...
        "Kiln-operator, porcelain",
        "Kiln-operator, pottery",
        "Kitchen helper",
        "Knitter",
        ...
        "Lay preacher",
        "Layer, floor",
        "Layer, tile, composition",
        "Layout man, stonework",
        ...
        "Lecturer",
        "Lecturer, college and university",
        "Legal Councel",
        "Legal adviser",
        "Legal analyst",
        ...
        "Machine operator, crushing, chemical and related pr",
        ...
        "Machine-operator, canning/freezing fruits & ve",
        ...
        "Machine-operator, grinding/chemical and relat",
        ...
        "Machine-operator, mixing, chemical and relate",
        "Machine-operator, pharmaceutical products",
        "Machine-operator, photographic/film productio",
        "Machine-operator, printing/photography",
        "Machine-operator, printing/photography",
        "Machine-operator, snack products such as co",
        ...
        "Maker, accordion",
        "Maker, brass instrument",
        "Maker, dental prosthesis",
        "Maker, ice cream",
        "Maker, instrument, meteorological",
        "Maker, instrument, surgical",
        "Maker, jewelry",
        "Maker, metal wind instrument",
        "Maker, optical instrument",
        "Maker, orthopedic appliance",
        "Maker, paper box, hand",
        "Maker, photographic film",
        "Maker, photographic paper",
        "Maker, piano",
        "Maker, pottery and porcelain",
        "Maker, precious metal leaf",
        "Maker, precision instrument",
        "Maker, stringed musical instrument",
        "Maker, umbrella",
        "Maker, wooden model",
        "Maker, woodwind instrument",
        "Maker-up, printing",
        "Make-up artist",
        "Make-up man (stage & studio)",
        "Malt cooker",
        ...
        "Manager, budgeting",
        "Manager, cargo and ramp service",
        "Manager, circulation",
        ...
        "Manager, customer credit",
        "Manager, customer service",
        "Manager, dance studio",
        "Manager, department, mutual benefits",
        ...
        "Manager, flight reservation",
        "Manager, front office",
        "Manager, handicraft shop",
        "Manager, harbor department",
        "Manager, industrial relations",
        "Manager, industrial zone",
        "Manager, internal audit",
        "Manager, machinery rental",
        "Manager, marketing",
        "Manager, messengerial services",
        "Manager, personal care services",
        "Manager, personnel",
        "Manager, planning",
        "Manager, port traffic",
        "Manager, production and operations, busines",
        "Manager, production and operations, commun",
        "Manager, production and operations, construc",
        "Manager, production and operations, hotels",
        "Manager, production and operations, manufac",
        "Manager, production and operations, restaura",
        "Manager, production and operations, retail tra",
        "Manager, production and operations, storage",
        "Manager, production and operations, transpor",
        "Manager, production and operations, wholesa",
        "Manager, production and operations/agricultu",
        "Manager, production and operations/fishing",
        "Manager, production and operations/forestry",
        "Manager, production and operations/hunting",
        "Manager, project development",
        "Manager, promotions department",
        "Manager, public relations",
        "Manager, purchasing",
        "Manager, railway",
        "Manager, research and development",
        "Manager, sales",
        "Manager, scientific publication",
        "Manager, specialized",
        "Manager, statement clerks",
        "Manager, stockroom",
        "Manager, storage",
        "Manager, storeroom",
        "Manager, student placement service",
        "Manager, supply",
        ...
        "Manager, traffic",
        "Manager, transport",
        "Manager, transport area",
        "Manager, transport station",
        ...
        "Managing proprietor, communications",
        "Managing proprietor, storage",
        "Managing proprietor, transport",
        "Managing-Proprietor, business services",
        "Managing-Proprietor, cleaning services",
        "Managing-proprietor, construction",
        "Managing-Proprietor, personal care services",
        ...
        "Mechanic, airconditioning plant",
        "Mechanic, aircraft engine",
        "Mechanic, aircraft engine service",
        "Mechanic, automobile",
        ...
        "Mechanic, radio",
        "Mechanic, reciprocating steam-engine",
        "Mechanic, refrigeration plant",
        "Mechanic, small engine",
        "Mechanic, telephone",
        "Mechanic, television",
        "Mechanic, turbine (except aircraft and marine)",
        ...
        "Medico-legal nurse",
        "Member of the Barangay Council (Sanggunian)",
        "Member of the City Council (Sangguniang Panlungsod)",
        "Member of the Municipal Council (Sanggunian)",
        "Member of the Provincial Board (Sangguniang Panlungsod)",
        ...
        "Molder, abrasive wheel",
        "Molder, bench, metal",
        "Molder, brick and tile",
        "Molder, floor and pit",
        "Molder, glass lens",
        "Molder, machine",
        ...
        "Nutritionist",
        "Nutritionist, community/public health",
        "Nutritionist, dietary",
        "Nutritionist, public health",
        "Nutritionist-dietician",
        "Nutritionist-dietician, research",
        "Ob- Gyenologist",
        "Obstetrician",
        ...
        "Office machine operator, reproduction proces",
        "Officer, excise",
        ...
        "Operator, boring equipment, well",
        "Operator, cement production plant",
        "Operator, centrifugal casting machine",
        "Operator, chipper, paper pulp",
        "Operator, clay extruding-press",
        "Operator, coke production plant",
        "Operator, computer equipment",
        "Operator, computer peripheral equipment",
        "Operator, continuous rod-casting machine",
        "Operator, converter, chemical processes, exc",
        "Operator, derrick, gas well",
        "Operator, derrick, oil well",
        "Operator, desk top publishing",
        "Operator, die casting machine",
        "Operator, drilling equipment, well",
        "Operator, EDP",
        "Operator, electric power plant",
        "Operator, electronic computer",
        "Operator, electronic equipment, n.e.c.",
        "Operator, engraving pantograph",
        "Operator, fertilizer plant",
        "Operator, fish hatchery",
        "Operator, hydroelectric power plant",
        "Operator, incinerator, refuse disposal",
        "Operator, lathe, stone",
        "Operator, lens grinding-machine",
        "Operator, lens polishing machine",
        "Operator, linotype",
        "Operator, loader",
        "Operator, metal furnace",
        "Operator, mill, chemical and related processes",
        "Operator, mineral crushing machine",
        "Operator, mineral milling machine",
        "Operator, mineral ore processing plant",
        "Operator, mobile plant",
        "Operator, monotype keyboard",
        "Operator, nuclear power plant",
        "Operator, nursery farm",
        "Operator, optical equipment, n.e.c.",
        "Operator, ore furnace",
        "Operator, ornamental fish farm",
        "Operator, paper pulp plant",
        "Operator, paper-making plant",
        "Operator, paraffin plant",
        "Operator, photo-type-setting machine",
        "Operator, plywood core-laying",
        "Operator, power plant",
        "Operator, pumping-station, water",
        "Operator, punched-card machine",
        "Operator, reactor, chemical processes, except petro",
        "Operator, roasting equipment, chemical and related",
        "Operator, robot, industrial",
        "Operator, rolling mill, non-ferrous metal",
        "Operator, sand pro",
        "Operator, sawmill",
        "Operator, separator, chemical and related materials",
        ...
        "Operator, stone processing machine",
        ...
        "Operator, tobacco conditioner",
        "Operator, tobacco cutting machine",
        "Operator, treating equipment, crude oil",
        "Operator, type-casting machine",
        "Operator, typewriter, telegraphic",
        ...
        "Paper box cutting- and creasing-press operat",
        ...
        "Patternmaker, hat and cap",
        "Patternmaker, leather",
        "Patternmaker, textile",
        "Patternmaker, wooden",
        "Paviour",
        "Pawnbroker",
        "Pay loader",
        ...
        "Press secretary",
        "Presser, hand",
        "Presser, hand, pottery and porcelain",
        "Pressman",
        ...
        "Private investigators/criminology",
        "Private police guard",
        "Private secretary",
        "Procurement officer",
        "Producer, chicken egg",
        "Producer, chicken meat",
        "Producer, duck egg",
        "Producer, duck meat",
        "Producer, motion picture",
        "Producer, radio program",
        "Producer, television program",
        "Producer, theatrical",
        ...
        "Quarry digger (manual)",
        "Quarryman (general)",
        "Rabbi",
        "Radio and television journalist",
        "Radio and television transmitting equipment o",
        "Radio announcer",
        ...
        "Raiser, frog",
        "Raiser, hog",
        "Raiser, pearl culture",
        "Rattan binder",
        "Reader, electric meter",
        "Reader, gas meter",
        "Reader, water meter",
        ...
        "Repairer, saw",
        "Repairer, telecommunication equipment",
        "Repairer, watch and clock",
        "Repairman",
        "Repairman, electric meter",
        "Repairman, electrical",
        "Repairman, instrumentation",
        "Repairman, telegraph",
        "Repairman, telephone",
        "Repairman, transformer",
        "Repairman, video electronics",
        "Reporter",
        "Reporter, verbatim",
        "Repro-cameraman",
        "Reservation clerk",
        ...
        "Revenue collector",
        "Revenue officer",
        "Rewinder, electric machine",
        "Rice farmer, irrigated",
        "Rice farmer, lowland",
        "Rice farmer, rainfed",
        "Rice farmer, upland",
        ...
        "Roofer, thatcher",
        "Roofer, tile",
        "Rotary driller, gas well",
        "Rotary driller, oil well",
        "Rotary pressman",
        ...
        "Sales analyst",
        "Sales associate professional, n.e.c.",
        "Sales consultant",
        ...
        "Salesman, business services/advertising",
        "Salesman, insurance",
        ...
        "Secretary, executive, government administrati",
        "Secretary, legal",
        "Secretary, marketing",
        "Secretary, medical",
        "Secretary, office",
        ...
        "Senior official, economic-interest organization",
        "Senior official, employers' organization",
        "Senior official, humanitarian organization",
        "Senior official, labor organization",
        "Senior official, labor union",
        "Senior official, political party",
        "Senior official, special-interest organization",
        "Senior official, trade union",
        "Senior Vice-President, organization/enterprise",
        "Sepulturero",
        "Sericulture worker",
        "Sericulturist",
        "Service and related worker (AFP)",
        "Service crew",
        "Servicer, audio electronics",
        "Setter, marble",
        "Setter, mosaic",
        "Setter, tile",
        "Setter, woodworking machine",
        "Setter-operator",
        "Setter-operator, wood lathe",
        "Setter-operator, wood routing machine",
        "Setter-operator, wood-planing machine",
        "Setter-operator, wood-shaping machine",
        "Setter-operator, wood-spindle-carving machine",
        "Setter-operator, woodworking machine",
        "Sewer",
        "Sewer, garment",
        "Sewing machine operator, industrial",
        "Sexton",
        "Sharpener, cutting instrument",
        "Sharpener, saw",
        "Sharpener, tool",
        "Sheep farm worker",
        "Sheet-metal marker",
        ...
        "Splicer, rope and cable, general",
        "Splitter, hide",
        "Splitter, stone",
        ...
        "Stripper, colored",
        "Stripper, tobacco, hand",
        "Stripper, tobacco, machine",
        ...
        "Superintendent, school, city",
        "Superintendent, school, division",
        "Supervising governor, organization/enterprise",
        "Supervising maritime industry development",
        "Supervisor, communications service",
        "Supervisor, district",
        "Supervisor, postal service",
        "Supervisor, production",
        "Supervisor, railway service",
        "Supervisor, sales workers",
        "Supervisor, sales, retail trade",
        "Supervisor, sales, wholesale trade",
        "Supervisor, telecommunications service",
        "Supervisor, transport service",
        "Supervisor, transport service, air",
        "Supervisor, transport service, railway",
        "Supervisor, transport service, road",
        "Supervisor, transport service, water",
        ...
        "Taxi driver",
        "Taxidermist",
        "Taxonomist, plants and animals",
        "Tea blender",
        "Tea plantation worker",
        "Tea processing machine operator",
        "Tea taster",
        "Teacher aide",
        "Teacher for adult literacy",
        ...
        "Teacher in advanced nursing",
        "Teacher in agricultural science, tertiary educa",
        "Teacher in economics and commerce, tertiary",
        "Teacher in education, tertiary education",
        "Teacher in engineering and architecture, tertia",
        "Teacher in history, philosophy, and sociology",
        "Teacher in home industries",
        "Teacher in industrial arts",
        "Teacher in languages and literature, tertiary e",
        "Teacher in law, tertiary education",
        "Teacher in life and medical sciences, tertiary",
        "Teacher in Mathematics, tertiary education",
        "Teacher in medical therapy",
        "Teacher in physical sciences, tertiary educatio",
        "Teacher in social sciences",
        "Teacher in trades",
        "Teacher, agricultural science, secondary educ",
        "Teacher, commercial and secretarial, seconda",
        "Teacher, domestic science, secondary educat",
        "Teacher, elementary mathematics",
        "Teacher, elementary school",
        "Teacher, elementary science",
        "Teacher, fine arts, secondary education",
        "Teacher, general nursing, secondary educatio",
        "Teacher, head",
        "Teacher, kindergarten",
        "Teacher, language, primary educatin",
        "Teacher, language, secondary education",
        "Teacher, literature, secondary education",
        "Teacher, mathematics, secondary education",
        "Teacher, natural science, secondary educatio",
        "Teacher, non-formal education",
        "Teacher, nursery school",
        "Teacher, preparatory school",
        "Teacher, primary education",
        "Teacher, professional, primary education",
        "Teacher, reading and writing, primary educati",
        "Teacher, reading and writing, secondary educ",
        "Teacher, social studies, primary education",
        "Teacher, social studies, secondary education",
        "Teacher, technical education, secondary educ",
        "Teacher, vocational education, secondary",
        ...
        "Technician, chemical engineering (petroleum)",
        "Technician, chemistry",
        "Technician, civil engineering (general)",
        "Technician, cobalt machine",
        "Technician, electric typewriter",
        "Technician, electrical engineering (general)",
        "Technician, electrical engineering (high voltage)",
        "Technician, electronics business machines",
        ...
        "Technician, extractive metallurgy",
        "Technician, forestry",
        "Technician, geology",
        "Technician, heating, ventilation and refrigeration",
        "Technician, industrial machinery and tools",
        "Technician, mechanical engineering (general)",
        "Technician, mechanical engineering (motors and en",
        "Technician, medical scanner",
        "Technician, medical science",
        "Technician, medical X-ray",
        "Technician, metallurgical engineering",
        "Technician, mining (general)",
        "Technician, mining engineering",
        "Technician, PABX",
        "Technician, petroleum and natural gas extraction",
        "Technician, physical metallurgy",
        "Technician, production engineering",
        "Technician, quantity surveying",
        "Technician, reprographic equipment",
        "Technician, skilled, semi-skilled worker (AFP)",
        "Technician, standard manual typewriter",
        "Technician, surveyor's",
        "Technician, telecommunications engineering",
        "Technician, time and motion study",
        "Technician, ultrasound machine",
        "Technologist, blood-bank",
        "Technologist, ceramics and glass",
        ...
        "Terrazo worker",
        "Test technician",
        "Tester, electrical products",
        "Tester, electronic products",
        "Tester, mechanical products",
        "Textile bleacher",
        ...
        "Train driver",
        "Trainor, vocational/technical",
        "Traning Center Manager",
        "Transferer, direct lithographic",
        ...
        "Vehicle cleaner",
        "Vendor, candy",
        "Vendor, cigarette stand",
        "Vendor, cigarette, ambulant",
        "Vendor, dry goods market",
        "Vendor, flower",
        "Vendor, newspaper stand",
        "Vendor, newspaper, ambulant",
        "Vendor, sidewalk stall",
        "Vendor, street ambulant",
        "Vendor, street food",
        "Vendor, wet market",
        "Veneer cutter",
        ...
        "Wallpaper printer",
        "Warden",
        "Wardrobe mistress, stage",
        "Wardrobe mistress, studio",
        "Warehouse aide",
        "Warehouse inspector",
        "Warehouse porter",
        ...
        "Welder",
        "Welder, electric",
        "Welder, electric arc, general",
        "Welder, electric arc, machine",
        "Welder, gas",
        ...
        "Worker reporting occupation unidentifiable",
        "Worker welfare assistant",
        "Working proprietor, cafe",
        "Working proprietor, catering",
        "Working proprietor, guest house",
        "Working proprietor, hotel",
        "Working proprietor, lodging",
    ...
    window.availableTribes = [
        // Add your list of tribes here
        "Abelling/Aberling",
        "Aeta",
        "Aeta/Ayta",
        ...
        "Agta-Cimaron" ,
        "Agta-Dumagat",
        "Agta-Dupanigan Agta-Labin",
        "Agta-Tabangnon Agta-Taboy Agutaynen",
        "Alta",
        "American",
        "Applai",
        ...
        "Itneg",
        "Iteng/Tinguian",
        "Iteng/Tinguian-Adasen",
        "Iteng/Tinguian-Balatok",
        "Iteng/Tinguian-Banao",
        "Iteng/Tinguian-Belwang",
        "Iteng/Tinguian-Binongan",
        "Iteng/Tinguian-Gubang",
        "Iteng/Tinguian-Inlaud",
        "Iteng/Tinguian-Mabaka",
        "Iteng/Tinguian-Maeng",
        "Iteng/Tinguian-Masadiit",
        "Iteng/Tinguian-Muyadan",
        "Ivatan",
        "Iwak",
        "Jama Mapun",
        "Japanese",
    ...
    // Function to initialize autocomplete for the specified fields
    function initializeAutocomplete() {
        // Initialize autocomplete for Father's Occupation
        $("input[name='father_occupation']").autocomplete({
            source: window.availableOccupations,
            minLength: 2,
        });

        // Initialize autocomplete for Mother's Occupation
        $("input[name='mother_occupation']").autocomplete({
            source: window.availableOccupations,
            minLength: 2,
        });

        // Initialize autocomplete for Father's Tribe
        $("input[name='father_tribe']").autocomplete({
            source: window.availableTribes,
            minLength: 2,
        });
    
        // Initialize autocomplete for Mother's Tribe
        $("input[name='mother_tribe']").autocomplete({
            source: window.availableTribes,
            minLength: 2,
        });
    }
    ...
    // Reinitialize autocomplete when the modal is shown
    $('#updateProfileModal').on('shown.bs.modal', function () {
        initializeAutocomplete(); // Reinitialize autocomplete for the modal
    });
});